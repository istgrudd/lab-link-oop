...
<%@page import="com.lablink.model.CommitteeMember"%> <%@page import="java.util.List"%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.0/font/bootstrap-icons.css"> <link rel="stylesheet" href="css/style.css">
    </head>
    <body>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    ...
                    <div class="card card-custom mb-4">
                        <div class="card-header card-header-custom">Edit Data Kegiatan</div>
